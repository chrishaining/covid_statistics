...
* 'Serology results for samples tested on 12 April will not be authorised until 14 April due to the Bank Holiday. Combined activity figures for 12 and 13 April will be reported on 14 April.'[Guidance: Number of coronavirus (COVID-19) cases and risk in the UK](https://www.gov.uk/guidance/coronavirus-covid-19-information-for-the-public). This presents a problem for data analysis. My solution is to include both days, using the mean average (mean=14_april_value/2). Even then, there is doubt as to the exact figures, as the government website on 15th April indicated that the published figures include 12th April. I think this problem isn't one I can solve, but that it will become less important as more data become available. 
